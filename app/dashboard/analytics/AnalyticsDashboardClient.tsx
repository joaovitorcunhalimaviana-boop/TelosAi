    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#0B0E14' }}>
        <div className="text-center">
          ...
          <p style={{ color: '#7A8299' }}>Carregando analytics...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#0B0E14' }}>
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mt-6 border-2" style={{ backgroundColor: '#111520', borderColor: '#1E2535' }}>
          <CardHeader>
            <CardTitle className="text-lg" style={{ color: '#F0EAD6' }}>Sobre os Dados</CardTitle>
            <CardDescription style={{ color: '#7A8299' }}>
              Informações importantes sobre a interpretação dos gráficos
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2 text-sm" style={{ color: '#7A8299' }}>
            <p>
