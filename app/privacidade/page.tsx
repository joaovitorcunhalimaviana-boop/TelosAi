      ...
      <div className="max-w-4xl mx-auto rounded-2xl shadow-xl p-8 md:p-12 border" style={{ backgroundColor: '#161B27', borderColor: '#1E2535' }}>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>1. Introdução</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>2. Dados Coletados</h2>
            <p className="mb-4" style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>3. Base Legal e Finalidade</h2>
            <p className="mb-4" style={{ color: '#D8DEEB' }}>
            ...
            <p className="mt-4" style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>4. Compartilhamento de Dados</h2>
            <p className="mb-4" style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>5. Segurança dos Dados</h2>
            <p className="mb-4" style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>6. Retenção de Dados</h2>
            <p style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>7. Seus Direitos (LGPD)</h2>
            <p className="mb-4" style={{ color: '#D8DEEB' }}>
              Você tem direito a:
            </p>
            <ul className="list-disc pl-6 space-y-2" style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>8. Cookies e Tecnologias Similares</h2>
            <p style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>9. Menores de Idade</h2>
            <p style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>10. Transferência Internacional</h2>
            <p style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>11. Alterações nesta Política</h2>
            <p style={{ color: '#D8DEEB' }}>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>12. Contato e Encarregado de Dados (DPO)</h2>
            <p className="mb-4" style={{ color: '#D8DEEB' }}>
            ...
            <p className="mt-4" style={{ color: '#D8DEEB' }}>
              ...
              caso de reclamações não resolvidas: <a href="https://www.gov.br/anpd"
                className="hover:underline" style={{ color: '#14BDAE' }} target="_blank" rel="noopener noreferrer">
                www.gov.br/anpd
              </a>
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#F0EAD6' }}>13. Sigilo Médico</h2>
            <p style={{ color: '#D8DEEB' }}>
          ...
          <div className="mt-12 pt-8 border-t border-[#1E2535]">
