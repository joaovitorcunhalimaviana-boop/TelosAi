...
export default function ComoFuncionaPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white">
      ...
      {/* Comparativo - Sistema Tradicional vs Telos.AI */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Veja como o Telos.AI se compara aos métodos convencionais de acompanhamento pós-operatório
              </p>
            </div>
          </FadeIn>
                      ...
                      <tr className="border-b border-gray-200">
                        ...
                        <th className="px-6 py-4 text-center bg-gradient-to-br from-telos-blue-500 to-telos-blue-600">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <span className="text-lg font-bold text-white">Telos.AI</span>
                          </div>
                        </th>
                      </tr>
                    </thead>
