...
export async function POST(request: NextRequest) {
  try {
    ...
    // Envia email (se o Resend estiver configurado)
    if (resend) {
      try {
      ...
      // Resend não configurado - loga o link de reset para desenvolvimento
      console.log("⚠️ RESEND_API_KEY não configurada. Link de reset:", resetUrl)
    }
